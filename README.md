...
- Optional **per-user notifications** (email + Discord DM) for signed-in visitors, and
  a **notification delegation API** so another app on your server can send through
